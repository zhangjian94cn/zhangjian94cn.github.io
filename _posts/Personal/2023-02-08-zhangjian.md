...
在研究生期间，我的主要研究方向是：自动驾驶场景下的高精度语义地图重建，技术主要涉及了：深度学习、机器人以及图形学等。在此期间，我分别完成了一篇专利与SCI期刊。此外，我曾在网易游戏渲染引擎组实习。

~~1）机器人的定位与建图（也就是常说的SLAM技术），2）使用神经网络实现信息融合，3）基于图形学技术实现可视化。在此期间，我分别完成了一篇专利与SCI期刊。此外，我曾在网易游戏渲染引擎组实习，获得了区别于普通offer的special offer。~~

毕业后，我进入阿里核心部门淘系技术部。在此期间，我提出了一套基于神经网络的自动化商品3D模型重建方案，完成了从算法设计，开发，测试，部署以及迭代优化的一整套工作。算法也成功上线手淘，方案获得了2022年淘宝双十一9大技术亮点之一等荣誉。此外，基于产品应用中的实际问题，我进行算法创新，形成了两篇论文，于22年分别被国际顶级会议CVPR，ECCV接受，我均为第一作者，技术受到了国际级认可，处在业内领先水平。同年5月，我晋升至高级算法工程师，并连续两年获得团队最高绩效。

（组织结构上的变动不利于长远发展，另一方面想拓宽下自己的技术栈）

去年7月，我来到英特尔，就职于大数据组下的高性能数据分析团队，从事梯度提升决策树的算法加速工作。期间，我深入算法原理与底层实现，提出了一套基于AVX向量化指令的算法加速方案。核心思想是：使用寄存器实现相对于L1更高一级的缓存，减少内存的存取操作，最终实现了相对于XGBoost 3倍以上的加速。期间，完成一篇论文，并获得2022第四季度团队最佳绩效。

通过这几年的工作经历：我形成了一套自己的算法设计与开发方法论。这让我在面对实际算法问题时，不仅能够快速的找到解决方案，同时尽可能的从问题本质出发设计算法，从根本上保证算法在实际应用中的效果。同时，我也一直保持着对技术的热情，持续阅读最新技术的相关论文，从中学习算法设计的核心思想。
...
**项目背景**： 随着手淘 3D 化的发展，“低成本、高质量的 3D 建模”成为主要的制约因素，而传统重建技术
（SFM）较易受到 mesh 表征（三角面片）的精度限制且鲁棒性差，难以应用于实际业务中
