...
2. 在阿里学到了什么
   ...
   1. 在阿里，我熟悉了一整套**基于深度学习算法的开发，优化以及部署流程**，让我对深度学习有了比较深刻的认识，包括：
      ...
      2）**非常全面的实现了算法应用的整个链路**，包括：图像分割，位姿估计，3D重建，图像融合等模块，
   ...
   2. 在阿里，我不仅仅满足于调用开源代码，而是**深入深度学习算法的设计思想，去灵活的解决实际问题**
      ...
      在这个过程中，我没有刻意追求创新，而是灵活的解决实际问题，最终我也将相关成果进行整理，发表了两篇顶级的人工智能论文，而且我都是第一作者，此外还有一篇专利，这也让我在阿里每年都是团队最好的绩效

   3. 

3. 在英特尔学到了什么
   
   1. 很幸运，在英特尔我所在的部门负责：人工智能应用的架构，
      包括1)高效的数据处理，2)分布式的大模型训练以及3)高性能的模型部署
      同时，
   2. 
